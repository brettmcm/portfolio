...
await writeFile(new URL('./stir-sessions/index.html', import.meta.url), renderCaseStudy(stirSessions));
console.log('Built Canary, Bloop, Dusty Times, and Stir Sessions case studies');
