...
export default {
  ...
  blocks: [
    ...
    text('challenge', 'Making room for another round', [
    ...
    text('identity', 'A little character goes a long way', [
    ...
    text('strategy', 'Good times should come easily', [
    ...
    text('color', 'A tight palette with room to grow', [
    ...
    text('packaging', 'Taking the identity onto the pack', [
    ...
    text('outcome', 'A shared starting point', [
